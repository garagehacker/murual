            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Other Fund</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Add Other Fund</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form  method="POST" action="{{route('others_funds.store')}}">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer" align="right">
                        ...
                        <a href="{{url('/others_funds')}}"  class="btn btn-danger">Back</a>
                    </div>
                </form>
            </div>
            <!-- /.card -->
